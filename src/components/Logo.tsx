...
export default function Logo({ size = 28, className = '', color = 'currentColor' }: LogoProps) {
  return (
    <svg
      ...
      className={className}
    >
      <line x1="22" y1="78" x2="22" y2="22" stroke={color} strokeWidth="8.5" strokeLinecap="round" />
      <line x1="22" y1="22" x2="78" y2="78" stroke={color} strokeWidth="8.5" strokeLinecap="round" />
      <line x1="78" y1="78" x2="78" y2="22" stroke={color} strokeWidth="8.5" strokeLinecap="round" />
